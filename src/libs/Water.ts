...
export default class Water extends ThreeWater {
  constructor (directinalLight: THREE.DirectionalLight, waterColor = 0x001e0f, sunColor = 0xffffff, fog = false, size = 10000, textureSize = 512) {
  ...
  setEnv = (params: {distortionScale: number, alpha: number}) => {
    ...
    if (params.distortionScale) uniforms.distortionScale.value = params.distortionScale
