...
export default class Particle extends THREE.Points {
  constructor (filename: string, num: number = 1000, hslColor = {h: 1.0, s: 0.2, l: 0.5}, size = 20) {
    super()
  ...
  private createMaterial = (filename: string, hslColor: {h: number; s:number; l: number}, size: number) => {
    ...
    const material = new THREE.PointsMaterial({ 
      ...
      transparent: true 
		...
		material.color.setHSL( hslColor.h, hslColor.s, hslColor.l, THREE.SRGBColorSpace )
    return material
  }
